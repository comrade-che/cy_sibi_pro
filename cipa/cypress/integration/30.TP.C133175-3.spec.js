...
describe('TC C133175 society group creating and field validation', () => {
    ...
    it("should do society group creating", () => {
        ...
        //Выбор наименования
        cy.get('.ng-option').contains('АО \«Самотлорнефтегаз\»').scrollIntoView();
        cy.wait(500);
        cy.get('.ng-option').contains('АО \«Самотлорнефтегаз\»').click();
        //Ввод описания
    ...
    it("should do society group field validation", () => {
        ...
        cy.get('.h2').contains('.h2', "АО \«Самотлорнефтегаз\» ").wait(500).click();
        cy.wait(500);
        ...
        .should("contain.text", 'АО \«Самотлорнефтегаз\»');
