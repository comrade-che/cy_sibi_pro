...
describe('TC C133177 object under implementation creating and field validation', () => {
    ...
    it("should do object under implementation creating", () => {
        ...
        .type('Техперевооружение систем измерения уровня РВС НГДУ "Арланнефть" (2019 г.), НСП "Четырманово"');
        ...
        cy.get('.ng-dropdown-panel span').contains('ИУ').click();
        //Ввод описания
    ...
    it("should do object under implementation field validation", () => {
        ...
        cy.get('.h2').contains("ИУ Техперевооружение систем измерения уровня РВС НГДУ... ").wait(500).click();
        cy.wait(500);
        ...
        .should("have.value", "Техперевооружение систем измерения уровня РВС НГДУ \"Арланнефть\" (2019 г.), НСП \"Четырманово\"");
