...
describe('TC C133195 object implementation stage for reference creating and field validation', () => {
    ...
    it("should do object implementation stage for reference creating", () => {
        ...
        .type('8. Пусконаладочные работы и опытно промышленная эксплуатация');
        //Ввод описания
    ...
    it("should do object implementation stage for reference field validation", () => {
        ...
        cy.get('.h2').contains("8. Пусконаладочные работы и опытно промышленная эк... ").wait(500).click();
        cy.wait(500);
        ...
        .should("have.value", "8. Пусконаладочные работы и опытно промышленная эксплуатация");
