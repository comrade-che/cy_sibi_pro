...
describe('TC C133189 for reference creating and field validation', () => {
    ...
    it("should do for reference creating", () => {
        ...
        .type('1.4.11. Система измерений и сведения баланса по установкам.');
        //Ввод описания
    ...
    it("should do for reference field validation", () => {
        ...
        cy.get('.h2').contains("1.4.11. Система измерений и сведения баланса по ус... ").click();
        cy.wait(500);
        ...
        .should("have.value", "1.4.11. Система измерений и сведения баланса по установкам.");
