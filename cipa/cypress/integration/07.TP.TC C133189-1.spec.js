...
describe('TC C133189 for reference creating and field validation', () => {
    ...
    it("should do for reference creating", () => {
        ...
        .type('1.4.19. Оснащение РВС № 656, 657, 658, 689-692, 843-845 системой измерения уровня');
        //Ввод описания
    ...
    it("should do for reference field validation", () => {
        ...
        cy.get('.h2').contains("1.4.19. Оснащение РВС № 656, 657, 658, 689-692, 84... ").click();
        cy.wait(500);
        ...
        .should("have.value", "1.4.19. Оснащение РВС № 656, 657, 658, 689-692, 843-845 системой измерения уровня");
